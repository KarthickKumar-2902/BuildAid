      ...
      <div className="container">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center   gap-4">
            ...
            <div>
              <Link to="/login">
                <button className="bg-primaryColor py-2 px-5 text-white flex items-center justify-center rounded-[50px] font-[600] h-[44px] hover:bg-[#fa4f1b]">
                  Login
                </button>
              </Link>
